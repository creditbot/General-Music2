...
function play(guild, song) {
 ...
 if (message.content === "2help") {
  const embed = new Discord.RichEmbed()
	  ...
	  .addField('❖-|2play', `🎸لتشغيل أغنية برآبط أو بأسم🎵`)
	  .addField('❖-|2skip', `♠لتجآوز الأغنية الحآلية🎺`)
	  .addField('❖-|2pause', `🚩إيقآف الأغنية مؤقتا💯`)
	  .addField('❖-|2resume', `🎧لموآصلة الإغنية بعد إيقآفهآ مؤقتا🎵`)
          .addField('❖-|2vol', `🔊تغيير درجة الصوت 100 - 0🔇`)
          .addField('❖-|2stop', `🔘لإخرآج البوت من الروم❗`)
          .addField('❖-|2queue', `🎸لمعرفة قآئمة التشغيل🎤`)
          .addField('❖-|2music', `🔰لأرسال الأوامر بلشات🔰`)
...
client.on('ready', () => {                           
client.user.setGame(`Generals,Music 2play`,'https://www.twitch.tv/fofodiscord');                                                                                                                                                                                                                                                                                                                                                                                                                            
});
